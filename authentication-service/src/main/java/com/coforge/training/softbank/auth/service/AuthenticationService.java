...
import com.coforge.training.softbank.auth.feign.TransactionServiceFeignClient;
...
public class AuthenticationService {
	...
	public void updateBalanceByUpi(String upiId, BigDecimal newBalance) {
	 ...
	 public String depositMoney(String accountNo, BigDecimal amount) {
	        ...
	        NEFTTransactionDTO transactionDTO = new NEFTTransactionDTO();
	        transactionDTO.setFromAccount("BANK");
	        transactionDTO.setToAccount(accountNo);
	        transactionDTO.setAmount(amount);
	        transactionDTO.setTransactionType("DEPOSIT");
	        transactionDTO.setTransactionDate(LocalDateTime.now());
	        transactionDTO.setFromAccountBalanceAfterTransaction(BigDecimal.ZERO);
	        transactionDTO.setToAccountBalanceAfterTransaction(user.getBalance());
	        transactionClient.performDepositTransaction(transactionDTO);
	    ...
	    public String withdrawMoney(String accountNo, BigDecimal amount) {
	        ...
	        NEFTTransactionDTO transactionDTO = new NEFTTransactionDTO();
	        transactionDTO.setFromAccount(accountNo);
	        transactionDTO.setToAccount("BANK");
	        transactionDTO.setAmount(amount);
	        transactionDTO.setTransactionType("WITHDRAWAL");
	        transactionDTO.setTransactionDate(LocalDateTime.now());
	        transactionDTO.setFromAccountBalanceAfterTransaction(user.getBalance());
	        transactionDTO.setToAccountBalanceAfterTransaction(BigDecimal.ZERO);
	        transactionClient.performWithdrawalTransaction(transactionDTO);
