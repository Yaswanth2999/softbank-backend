...
public class TransactionController {
    ...
    @PostMapping("/deposit")
    public ResponseEntity<String> performDepositTransaction(@RequestBody NEFTTransactionDTO transactionDTO) {
        transactionDTO.setTransactionType("DEPOSIT");
        String response = transactionService.performDepositTransaction(transactionDTO);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    @PostMapping("/withdrawal")
    public ResponseEntity<String> performWithdrawalTransaction(@RequestBody NEFTTransactionDTO transactionDTO) {
        transactionDTO.setTransactionType("WITHDRAWAL");
        String response = transactionService.performWithdrawalTransaction(transactionDTO);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
